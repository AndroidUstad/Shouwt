...
import 'features/feed/presentation/bloc/video_cubit.dart';
...
void main() async {
  ...
  isUserLoggedIn = await getIt<AuthHelper>().isAuthorized();
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<bool>(
      future: localDataSource!.getDarkMode(),
        ...
        return MultiBlocProvider(
          providers: [
            ...
            BlocProvider<ApplicationCubit>(
              create: (BuildContext context) => getIt<ApplicationCubit>(),
            ),
            BlocProvider<StoriesBloc>(
              create: (BuildContext context) => getIt<StoriesBloc>(),
            ),
            BlocProvider<VideoCubit>(
              create: (BuildContext context) => getIt<VideoCubit>(),
            ),
            BlocProvider<FollowersFollowingCubit>(
              create: (BuildContext context) =>
                  getIt<FollowersFollowingCubit>(),
            ),
          ],
