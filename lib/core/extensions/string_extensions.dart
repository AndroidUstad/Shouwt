...
extension StringExtensions on String {
  String get hostName {
    final _uri = Uri.parse(this);
    final _hostname =
        _uri.host.split('.')[_uri.host.split('.').length - 2].capitalize();
    final _lastWord = _uri.host.split('.')[_uri.host.split('.').length - 1];
    return _hostname + '.' + _lastWord;
  }
  ...
  String get makeValidUrl {
    if (!this.contains('https')) return Strings.baseMediaUrl + this;
    return this;
  }
