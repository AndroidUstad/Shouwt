...
import 'package:colibri/application_cubit.dart';
import 'package:colibri/auth_helper.dart';
import 'package:colibri/core/di/injection.dart';
import 'package:colibri/features/authentication/domain/usecase/login_with_facebook_use_case.dart';
import 'package:colibri/features/authentication/domain/usecase/login_with_google_use_case.dart';
import 'package:colibri/features/authentication/presentation/bloc/login_cubit_helper.dart';
import 'package:colibri/features/authentication/presentation/bloc/sign_up_cubit.dart';
import 'package:colibri/features/feed/domain/usecase/reply_to_post_use_case.dart';
...
import 'package:colibri/features/profile/domain/usecase/delete_follow_request_use_case.dart';
import 'package:colibri/features/profile/domain/usecase/get_privacy_settings_use_case.dart';
import 'package:colibri/features/profile/domain/usecase/get_profile_settings_use_case.dart';
import 'package:colibri/features/profile/domain/usecase/report_profile_use_case.dart';
import 'package:colibri/features/stories/data/stories_repo_implementation.dart';
import 'package:colibri/features/stories/domain/repo/stories_repo.dart';
...
import '../../features/profile/domain/usecase/approve_follow_request_use_case.dart';
import '../../features/profile/domain/usecase/fetch_follow_requests_use_case.dart';
import '../../features/profile/presentation/pagination/request/follow_request_pagination.dart';
import '../../features/stories/domain/usecase/delete_swift_media_usecase.dart';
import '../../features/stories/domain/usecase/delete_swift_usecase.dart';
import '../../features/stories/domain/usecase/get_swift_list_usecase.dart';
import '../../features/stories/domain/usecase/publish_swift_usecase.dart';
import '../../features/stories/domain/usecase/register_swift_view_usecase.dart';
import '../../features/stories/domain/usecase/upload_swift_media_usecase.dart';
...
Future<GetIt> $initGetIt(
  ...
  gh.factory<StoriesRepo>(() => StoriesRepoImplementation(get<ApiHelper>()));
  ...
  gh.factory<ApproveFollowRequestUseCase>(
      () => ApproveFollowRequestUseCase(get<ProfileRepo>()));
  gh.factory<DeleteFollowRequestUseCase>(
      () => DeleteFollowRequestUseCase(get<ProfileRepo>()));
  gh.factory<ChangePasswordUseCase>(
      () => ChangePasswordUseCase(get<ProfileRepo>()));
  gh.factory<UpdatePrivacyUseCase>(
      () => UpdatePrivacyUseCase(get<ProfileRepo>()));
  gh.factory<GetPrivacySettingsUseCase>(
      () => GetPrivacySettingsUseCase(get<ProfileRepo>()));

  gh.factory<UpdateProfileCoverUseCase>(
      () => UpdateProfileCoverUseCase(get<ProfileRepo>()));
  gh.factory<UpdateProfileSettingsUseCase>(
      () => UpdateProfileSettingsUseCase(get<ProfileRepo>()));
  ...
  gh.factory<AuthHelper>(() => AuthHelper(get<LocalDataSource>(), get<Dio>()));
  ...
  gh.factory<FetchFollowRequestsUseCase>(
      () => FetchFollowRequestsUseCase(get<ProfileRepo>()));
  ...
  gh.factory<GetProfileSettingsUseCase>(
      () => GetProfileSettingsUseCase(get<ProfileRepo>()));
  ...
  gh.factory<LoginWithFacebookUseCase>(
      () => LoginWithFacebookUseCase(get<AuthRepo>()));
  gh.factory<LoginWithGoogleUseCase>(
      () => LoginWithGoogleUseCase(get<AuthRepo>()));
  gh.factory<LoginCubitHelper>(() => LoginCubitHelper());
  gh.factory<LogOutUseCase>(() => LogOutUseCase(get<ProfileRepo>()));
  gh.factory<ReplyToPostUseCase>(() => ReplyToPostUseCase(get<PostRepo>()));
  gh.factory<LoginCubit>(() => LoginCubit(
        get<LocalDataSource>(),
        get<LoginUseCase>(),
        get<LoginCubitHelper>(),
        get<LoginWithFacebookUseCase>(),
        get<LoginWithGoogleUseCase>(),
      ));
  gh.factory<VideoCubit>(() => VideoCubit(get<LikeUnlikeUseCase>(),
      get<RepostUseCase>(), get<ReplyToPostUseCase>()));

  gh.factory<ApplicationCubit>(() => ApplicationCubit());

  gh.factory<StoriesBloc>(() => StoriesBloc(
        get<DeleteSwiftMediaUseCase>(),
        get<DeleteSwiftUseCase>(),
        get<GetSwiftListUseCase>(),
        get<PublishSwiftUseCase>(),
        get<RegisterSwiftViewUseCase>(),
        get<UploadSwiftMediaUseCaes>(),
      ));

  gh.factory<DeleteSwiftMediaUseCase>(
      () => DeleteSwiftMediaUseCase(get<StoriesRepo>()));
  gh.factory<DeleteSwiftUseCase>(() => DeleteSwiftUseCase(get<StoriesRepo>()));
  gh.factory<GetSwiftListUseCase>(
      () => GetSwiftListUseCase(get<StoriesRepo>()));

  gh.factory<PublishSwiftUseCase>(
      () => PublishSwiftUseCase(get<StoriesRepo>()));
  gh.factory<RegisterSwiftViewUseCase>(
      () => RegisterSwiftViewUseCase(get<StoriesRepo>()));
  gh.factory<UploadSwiftMediaUseCaes>(
      () => UploadSwiftMediaUseCaes(get<StoriesRepo>()));
  ...
  gh.factory<UserSettingCubit>(() => UserSettingCubit(
        getIt<GetProfileSettingsUseCase>(),
        getIt<UpdateProfileSettingsUseCase>(),
        getIt<LocalDataSource>(),
        getIt<ChangeLanguageUseCase>(),
        getIt<ChangePasswordUseCase>(),
        getIt<VerifyUserAccountUseCase>(),
        getIt<DeleteAccountUseCase>(),
        getIt<GetPrivacySettingsUseCase>(),
        getIt<UpdatePrivacyUseCase>(),
      ));
  ...
  gh.factory<FollowRequestPagination>(
      () => FollowRequestPagination(get<FetchFollowRequestsUseCase>()));
  ...
  gh.factory<FollowersFollowingCubit>(() => FollowersFollowingCubit(
        ...
        get<FollowRequestPagination>(),
        get<FollowUnFollowUseCase>(),
        get<GetProfileUseCase>(),
        get<ApproveFollowRequestUseCase>(),
        get<DeleteFollowRequestUseCase>(),
      ));

  // Eager singletons must be registered in the right order
  gh.singleton<AuthRepo>(
      AuthRepoImpl(get<ApiHelper>(), get<LocalDataSource>()));
  return get;
}
