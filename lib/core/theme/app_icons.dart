...
class AppIcons {
  ...
  static Widget frontBackSwitchIcon() => Images.frontBackSwitchIcon.toSvg();
  static Widget refreshIcon({
    Color color = Colors.white,
  }) =>
      Images.refresh.toSvg(
        color: color,
        height: 20,
        width: 20,
      );
  ...
  static Widget moonIcon({Color? color}) =>
      Images.moon.toSvg(height: 15, width: 15, color: color);
  static SvgPicture rowImage = Images.row_image.toSvg();
  static SvgPicture rowGif = Images.row_gif.toSvg();
  static SvgPicture rowEmojis =
      Images.row_emojis.toSvg(color: AppColors.colorPrimary);
  ...
  static Widget drawerBookmark1({Color? color}) =>
      Images.drawerBookmark1.toSvg(color: color);
  static Widget drawerProfile =
      Images.drawerProfile.toSvg(height: drawerMenuSize, width: drawerMenuSize);
  static Widget drawerProfile1({Color? color}) =>
      Images.drawerUser1.toSvg(height: 30, width: 30, color: color);
