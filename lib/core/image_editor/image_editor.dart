...
class EditorImageResult {
  ...
  EditorImageResult(this.imgWidth, this.imgHeight, this.newFile, this.caption);
}
          ...
          child: Screenshot(
            ...
            child: Stack(
              children: [
                ...
                Positioned.fromRect(
                    rect: Rect.fromLTWH(
                        0, headerHeight, screenWidth, canvasHeight),
                    child: RotatedBox(
                ...
                child: Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      contentPadding:
                          REdgeInsets.symmetric(vertical: 7, horizontal: 10),
                      isDense: true,
