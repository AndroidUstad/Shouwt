...
class FeedCubit extends PostPaginatonCubit<PostEntity, CommonUIState>
  ...
  bool emojisVisible = false;
  bool isPhotoOnly = false;
  String muteStringKey = '';
  ...
  void changeMuteKey(String key) {
    emit(const CommonUIState.initial());
    muteStringKey = key;
    emit(const CommonUIState.success(''));
  }

  void changeEmojisVisiblity(bool isVisible) {
    emit(const CommonUIState.initial());
    emojisVisible = isVisible;
  ...
  void changeKeyboardVisiblity(bool isVisible) {
    emit(const CommonUIState.initial());
