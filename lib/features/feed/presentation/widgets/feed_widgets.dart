        ...
        children: [
          widget.postEntity?.showRepostedText ?? false
              ? Padding(
                  ...
                  child: Row(
                    children: [
                      AppIcons.repostIcon(color: isDark ? Colors.white : null),
                      12.toSizedBox,
            ...
            [
              ...
              if (widget.postEntity!.description.isNotEmpty)
                widget.postEntity!.description.toSubTitle1(
                    ...
                    fontFamily1: "Poppins", onTapHashtag: (hTag) {
              ...
              if (widget.postEntity!.type == 'poll')
                PollContainer(widget.postEntity!)
              else
                Container(child: imageVideoSliderData()),
