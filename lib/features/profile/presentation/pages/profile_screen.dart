...
import '../../../../core/listeners/profile_listeners.dart';
import '../../../../main.dart';
...
class _ProfileScreenState extends State<ProfileScreen>
                        ...
                        child: Stack(
                          children: [
                            ...
                            TabBar(
                              ...
                              tabs: [
                                Tab(text: LocaleKeys.posts.tr()).toContainer(
                                ...
                                Tab(text: LocaleKeys.media.tr()).toContainer(
                                  alignment: Alignment.center,
                                  decoration: BoxDecoration(
                                    color: isDark
                                        ? AppColors.appBlackColor
                                ...
                                Tab(text: LocaleKeys.likes.tr()).toContainer(
                                  alignment: Alignment.center,
                                  decoration: BoxDecoration(
                                    color: isDark
                                        ? AppColors.appBlackColor
  ...
  num calculateHeight({
    ...
    final defaultHeight = isSmallInches ? height * .6 : height * .55;
