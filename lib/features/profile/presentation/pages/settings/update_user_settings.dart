...
// import 'package:colibri/features/profile/presentation/pages/settings/update_dark_mode_model.dart';
...
//       {Key? key,
//       required this.updateSettingEnum,
//       this.onTapSave,
...
//                           child: getHomeWidget(widget.updateSettingEnum),
//                         ),
//                         10.toSizedBox,
//                         CustomButton(
//                           text: _getButtonText(
...
//                               title: 'Country'
//                                   .toSubTitle2(fontWeight: FontWeight.w500),
//                               subtitle: snapshot.data!.country!.toCaption(
//                                 fontWeight: FontWeight.w500,
//                               ),
//                             ),
...
//       builder: (context, AsyncSnapshot<List<String>> countrySnapshot) {
//         return countrySnapshot.data == null
//             ? const SizedBox()
//             : [
//                 11.toSizedBox,
...
//                                   widget.settingEntity.displayLanguage!]!
...
//                         )
//                         .toList(),
//                     selectedValue: widget.settingEntity.displayLanguage,
//                     onChange: (s) {
//                       userSettingCubit!
//                         ..changeSettingEntity(
//                           widget.settingEntity.copyWith(
//                             displayLang: s.value,
//                           ),
//                         )
