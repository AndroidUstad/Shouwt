...
//                     },
//                     error: (e) =>
//                         context.showSnackBar(message: e, isError: true));
//               },
...
//             settingEntity,
//             UpdateSettingEnum.CHANGE_LANGUAGE,
//           );
//         },
//       ),
...
//       profileItem(isDark ? 'Dark Theme' : 'Light Theme',
//           'Click to change theme', context, onTap: () {
//         openUpdateBottomSheet(settingEntity, UpdateSettingEnum.THEME);
//       }, makeBottomBorder: false),
//       30.toSizedBox,
...
//             url: Strings.termsUrl, name: LocaleKeys.terms_of_use.tr()));
//       }),
//       profileItem(LocaleKeys.privacy_policy.tr(),
//           "Click for our privacy details", context, onTap: () {
//         context.router.root.push(WebViewScreenRoute(
//             url: Strings.privacyUrl, name: LocaleKeys.privacy_policy.tr()));
//       }),
//       profileItem(
...
//         },
//       ),
//       profileItem(LocaleKeys.about_us.tr(), "Read about us", context,
//           onTap: () {
//         context.router.root.push(
//           WebViewScreenRoute(
//             url: Strings.aboutUs,
...
//                   userSettingCubit!.firstNameValidator.textController.text =
//                       settingEntity.firstName!;
//                   context.showSnackBar(
//                     message: "First name must not be empty",
//                     isError: true,
//                   );
//                 } else if (userSettingCubit!.lastNameValidator.text.isEmpty) {
//                   context.router.root.pop();
...
//                   context.showSnackBar(
//                       message: "Last name must not be empty", isError: true);
//                 } else if (userSettingCubit!.userNameValidator.text.isEmpty) {
//                   context.router.root.pop();
...
//                   context.showSnackBar(
//                       message: "Username must not be empty", isError: true);
//                 } else {
...
//                 } else if (userSettingCubit!
//                         .newPasswordValidator!.text.isEmpty ||
//                     userSettingCubit!.confirmPasswordValidator!.text.isEmpty ||
...
//                 if (userSettingCubit!.deleteAccountValidator.text.isValidPass)
//                   userSettingCubit!.deleteAccount(context);
//                 else
//                   context.showSnackBar(
//                       message: userSettingCubit!.deleteAccountValidator.text);
//                 context.router.root.pop();
//                 break;
...
//     {VoidCallback? onTap, bool makeBottomBorder = true}) {
//   return Container(
//     decoration: makeBottomBorder
//         ? BoxDecoration(
//             border: Border(
//               bottom: BorderSide(
