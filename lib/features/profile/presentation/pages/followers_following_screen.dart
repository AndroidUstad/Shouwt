...
import '../widgets/follow_request/follow_request_item.dart';
import '../../../../main.dart';
    ...
    switch (widget.followScreenEnum) {
      ...
      case FollowUnFollowScreenEnum.FOLLOWING:
        tabController!.animateTo(1,
            ...
            curve: Curves.easeInBack);
        break;
      case FollowUnFollowScreenEnum.REQUESTS:
          ...
          headerSliverBuilder: (context, value) {
            return [
              SliverAppBar(
                ...
                leading: const BackButton(color: AppColors.colorPrimary),
                elevation: 0.0,
                floating: true,
                pinned: true,
                    ...
                    children: [
                      ...
                      TabBar(
                        ...
                        tabs: [
                          Tab(
                            text:
                                "${LocaleKeys.followers.tr()} (${widget.profileEntity.followerCount})",
                          ).toContainer(
                          ...
                          Tab(
                            text:
                                "${LocaleKeys.following.tr()} (${widget.profileEntity.followingCount})",
                          ).toContainer(
                            alignment: Alignment.center,
                            decoration: BoxDecoration(
                              color: isDark
              ...
              children: [
                ...
                RefreshIndicator(
                  ...
                  child: PagedListView.separated(
                    padding: const EdgeInsets.only(bottom: 10),
                    pagingController: followersFollowingCubit!
                        .followRequestPagination.pagingController,
                    builderDelegate:
                        PagedChildBuilderDelegate<FetchFollowRequestsItem>(
                      noItemsFoundIndicatorBuilder: (_) => NoDataFoundScreen(
                        buttonText: LocaleKeys.go_back.tr(),
                        icon: AppIcons.personOption(
                          size: 35,
                        ...
                        title: LocaleKeys.no_subscription_requests.tr(),
                        message: 'There are no follow requests yet',
                        onTapButton: () {
                          context.router.root.pop();
                        },
                      ),
                      itemBuilder: (_, FetchFollowRequestsItem item, __) =>
                          FollowRequestItem(item),
                    ),
                    separatorBuilder: (BuildContext context, int index) =>
                        const Divider(),
                  ),
...
enum FollowUnFollowScreenEnum { FOLLOWERS, FOLLOWING, REQUESTS }
