...
import '../widgets/messages_app_bar_row.dart';
import '../../../../main.dart';
                  ...
                  builder: (context, snapshot) {
                    return NoDataFoundScreen(
                      ...
                      icon: Images.search.toSvg(
                          color: AppColors.colorPrimary, height: 40, width: 40),
                      ...
                      : CustomAnimatedWidget(
                          child: OpenContainer<dynamic>(
                            ...
                            openBuilder: (i, c) => ChatScreen(
                              ...
                              otherUserFullName: snapshot.data![index].fullName,
                ...
                RichText(
                  ...
                  text: TextSpan(
                    ...
                    style: context.subTitle1.copyWith(
                      color: isDark ? Colors.white : const Color(0xFF3D4146),
