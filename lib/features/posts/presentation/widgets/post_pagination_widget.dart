...
import '../../../stories/presentation/pages/stories_widget.dart';
...
class _PostPaginationWidgetState extends State<PostPaginationWidget> {
  ...
  @override
  Widget build(BuildContext context) => PagedListView<int, PostEntity?>(
  ...
  PagedChildBuilderDelegate<PostEntity?> buildHome() =>
      PagedChildBuilderDelegate<PostEntity?>(
        firstPageErrorIndicatorBuilder: (c) => CustomFirstPageView(
          onTryAgain: widget.pagingController.refresh,
        ),
        firstPageProgressIndicatorBuilder: (_) => DefaultCircularProgress(),
        newPageProgressIndicatorBuilder: (_) => DefaultCircularProgress(),
        ...
        itemBuilder: (BuildContext context, PostEntity? item, int index) {
          ...
          return Column(
            children: [
              if (index == 0 && widget.isFeed) StoriesWidget(),
              VisibilityDetector(
                    ...
                    onPostOptionItem: (value) {
                      ...
                      switch (getOptionsEnum) {
                        ...
                        case PostOptionsEnum.BOOKMARK:
                          widget.onOptionItemTap(
                              PostOptionsEnum.BOOKMARK, index);
                          break;
                        ...
                        case PostOptionsEnum.BLOCK:
                          context.showOkCancelAlertDialog(
                              desc: LocaleKeys
                                  ...
                                  .tr(),
                              title:
                                  LocaleKeys.please_confirm_your_actions.tr(),
