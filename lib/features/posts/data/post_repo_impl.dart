...
import 'model/response/reply_to_post_response/reply_to_post_response.dart';
import 'model/request/reply_to_post_request.dart';
...
class PostRepoImpl extends PostRepo {
  ...
  @override
  Future<Either<Failure, ReplyToPostResponse>> replyToPost(
    ReplyToPostRequest params,
  ) async {
    final response =
        await apiHelper!.post(ApiConstants.publishPost, params.toMap());
    return response.fold(
      (l) => Left(l),
      (r) => Right(ReplyToPostResponse.fromJson(r.data)),
    );
  }
}
